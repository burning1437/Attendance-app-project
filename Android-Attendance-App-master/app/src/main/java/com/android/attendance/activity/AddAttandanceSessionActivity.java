...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	String subject = "ITE301";

	private String[] branchString = new String[] { "BSIT"};
	private String[] yearString = new String[] {"1st","2nd","3rd","4th"};
	private String[] subjectSEString = new String[] {"ITE301","ITE307"};
	private String[] subjectTEString = new String[] {"ITE308","SSP007"};
	private String[] subjectBEString = new String[] {"ITE ELEC1","ITE328"};

	private String[] subjectFinal = new String[] {"N/A","N/A","N/A","N/A","N/A","N/A"};
